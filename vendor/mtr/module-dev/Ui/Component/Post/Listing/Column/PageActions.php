...
{
    /** Url path */
    const POST_URL_PATH_EDIT = 'mtr/post/edit';
    const POST_URL_PATH_DELETE = 'mtr/post/delete';
    const POST_URL_PATH_DISABLE = 'mtr/post/disable';
    const POST_URL_PATH_ENABLE = 'mtr/post/enable';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['post_id'])) {
                    ...
                    $item[$name]['enable'] = [
                        'href' => $this->urlBuilder->getUrl(self::POST_URL_PATH_ENABLE, ['post_id' => $item['post_id']]),
                        'label' => __('Enable'),
                    ];
                    $item[$name]['disable'] = [
                        'href' => $this->urlBuilder->getUrl(self::POST_URL_PATH_DISABLE, ['post_id' => $item['post_id']]),
                        'label' => __('Disable'),
                    ];
